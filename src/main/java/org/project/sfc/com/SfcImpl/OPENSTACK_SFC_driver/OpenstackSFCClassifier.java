...
public class OpenstackSFCClassifier extends SFCclassifier {
  ...
  private static Logger logger = LoggerFactory.getLogger(OpenstackSFCClassifier.class);
  ...
  public OpenstackSFCClassifier() throws IOException {
  ...
  */
  ...
  public ACLJSON build_acl_json(SFCCdict sfcc_dict, String rsp_id) {
    ...
    acl_json.getAccessLists().getAcl().get(0).setAclType("ietf-access-control-list:ipv4-acl");
